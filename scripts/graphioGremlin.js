...
//                        }
	...
	function click_query(d) {
		...
		var gremlin_query_edges = "edges = " + "__" + ".V("+id+").bothE("+(edge_filter?"'"+edge_filter+"'":"")+")";
	...
	function run_websocket_request(gremlin_query,server_url,query_type,active_node,message,callback){
		...
		console.log("🚀 ~ file: graphioGremlin.js ~ line 317 ~ run_websocket_request ~ data", data)
		...
		ws.onmessage = function (event){
			...
			console.log("🚀 ~ file: graphioGremlin.js ~ line 347 ~ run_websocket_request ~ data", data)
			if (data == null){
